  ...
  return (
    <>
      <div className="container mt-5 p-5 ">
        ...
        <div className="row mt-5 p-5 border-top text-muted p-5 fs-6 "style={{lineHeight:"1.9",fontSize:"1.2em"}}>
          <div className="col-6 p-5">
            <p>
              ...
              word for barrier. </p> <p> Today, our disruptive pricing models and
              in-house technology have made us the biggest stock broker in
              India. </p> <p> Over 1.6+ crore clients place billions of orders every year
          ...
          <div className="col-6 p-5">
            ...
            about us or learn more about our business and product philosophies. </p>
          </div>
        </div>
